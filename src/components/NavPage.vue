<template>
    <div class="w-full max-w-7xl mx-auto py-10 flex justify-between items-center fixed top-4 z-20">
        <div class="pl-10 z-50" @click="isOpen === true ? isOpen = false : isOpen = true" :class="isOpen && 'on'">
        ...
        <h1 class="basis-10/12"><router-link to="/">로고</router-link></h1>
